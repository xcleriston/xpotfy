...
class Logger {
     ...
     */
    logPosition(position, action, context) {
     ...
     */
    logMarketData(marketData, context) {
     ...
     */
    logStrategySignal(signal, context) {
     ...
     */
    logExecutionPerformance(operation, duration, context) {
     ...
     */
    logArbitrageOpportunity(opportunity, context) {
     ...
     */
    logHedgeOperation(marketId, hedgeType, size, context) {
